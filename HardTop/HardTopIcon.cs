...
namespace HardTop
{
    internal static class HardTopIcon
    {
        #region Icon Size
        ...
        internal static Icon GetIcon(int HardTop)
        {
            Icon icon = null;
            using (Bitmap bitmap = new Bitmap(_size, _size))
            using (Graphics graphics = Graphics.FromImage(bitmap))
            {
                DrawBackgroundOnGraphics(HardTop, graphics);
                DrawHardTopOnGraphics(HardTop, graphics);
        ...
        internal static bool SaveIcon(int HardTop, string fullPath)
        {
            bool result = true;
            Icon icon = null;
        ...
        private static void DrawBackgroundOnGraphics(int HardTop, Graphics graphics)
        {
        ...
        private static void DrawHardTopOnGraphics(int HardTop, Graphics graphics)
        {
